...
console.log("id----------",id);
  ...
  style={{
    ...
    height: '2vh',            // Ensures it takes up full viewport height
  }}
>
  {/* <h2
  className="mb-3"
...
>
  {editMode ? 'Edit Application' : 'View Application'}
</h2> */}
</div>
...
<div>
    ...
    marginBottom: '10px', // Spacing after the header
  }}>Primary Info</h2>
  ...
  <span className="fw-bold fs-5">{formData.name}</span>
            ...
            <div className="col-md-3">
                ...
                <label  className="form-label form-label-sm text-muted">Status</label></div>
                         <div className="col-md-3">
                         {editMode ? (
    <select
      name="leadStatus"
  ...
  {editMode ? ( 
          ...
          <div className="col-md-3">
  <label className="form-label form-label-sm text-muted">Recruiter</label>
</div>
<div className="col-md-3">
  {editMode ? (
    <select
...
<div className="col-md-3">
  <label className="form-label form-label-sm text-muted">Interviewer</label>
</div>
<div className="col-md-3">
  {editMode ? (
    <select
...
<span className="fw-bold fs-5">
  { formData.nextFollowUpDate ? `${String(new Date(formData.nextFollowUpDate).getDate()).padStart(2, '0')}/${String(new Date(formData.nextFollowUpDate).getMonth() + 1).padStart(2, '0')}/${new Date(formData.nextFollowUpDate).getFullYear()}` :''}
            ...
            <div className="row mb-3">
      {/* <div className="col-md-3">
                <label  className="form-label form-label-sm text-muted">Source</label></div>
                         <div className="col-md-3">
                         {editMode ? (
    <select
      name="leadSource"
