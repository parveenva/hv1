export default function POST(req, res) {
    var { name, email, contact, message } = req.body;
  ...
  var mailist = ['parveenemail@gmail.com'
    ...
    const mailData = {
      ...
      to: mailist ,
      subject: "Message from the CODE91 Website (CONTACT US)",
      text: "Plaintext version of the message",
      html: `<h3>Name of the client : ${name} </h3>
               <h3>Phone number of the client : ${contact} </h3>
               <h3>Email of the client : ${email} </h3>
               <h3>Message of the client : ${message} </h3>`,
    };
