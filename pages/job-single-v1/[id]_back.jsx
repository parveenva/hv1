...
const JobSingleDynamicV1 = () => {
  ...
  const jobId = router.query._id;

  const [company, setCompany] = useState({});
 
  const { user, isLoggedIn , getUserRole} = useAuth();

  const [isApplyJobModalOpen, setIsApplyJobModalOpen] = useState(false);

  // Function to handle application submission
  const handleApplyJob = () => {
    // Check if the user is logged in with the candidate role
    if (!isLoggedIn || getUserRole() !== "candidate") {
      // Redirect the user to the login page
      router.push("/login"); // Replace with your actual login page URL
      return;
    }
            ...
            <div className="job-block-seven">
              <div className="inner-box">
                ...
                <div
                  ...
                  tabIndex="-1"
                  aria-hidden="true"
                  style={{ display: isApplyJobModalOpen ? "block" : "none" }}
